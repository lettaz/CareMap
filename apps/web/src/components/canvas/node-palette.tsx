...
export function NodePalette() {
  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      <SheetTrigger className="absolute bottom-4 left-4 z-10 flex h-10 w-10 items-center justify-center rounded-full bg-cm-accent text-white shadow-md transition-colors hover:opacity-90">
