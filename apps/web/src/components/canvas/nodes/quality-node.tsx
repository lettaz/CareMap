...
export function QualityNode({ id, data }: NodeProps<PipelineNode>) {
  ...
  return (
    <div className="relative w-[180px] rounded-lg border border-cm-border-primary bg-white shadow-sm">
      <div className="absolute left-0 top-0 bottom-0 w-1 rounded-l-lg bg-cm-node-quality" />
      <div className="p-3 pl-4">
        <div className="flex items-center gap-2">
          <ShieldCheck className="h-4 w-4 shrink-0 text-cm-node-quality" />
      ...
      <Handle
        ...
        className="!h-2 !w-2 !bg-cm-node-quality"
      />
      <Handle
        type="source"
